...
public class GetDataServiceProviders extends AsyncTask<Void,Void,String> {
	 HttpPost httppost; 
	    StringBuffer buffer; 
	    ...
	    String tempp[];
	        ...
	        public GetDataServiceProviders(String city,Object obj) { 
	             this.city = city; 
	             ss = obj;        
	    } 
	    ...
	    try { 
	        ...
	        httppost= new HttpPost("http://www.aimtplacementcell.net23.net/hoteltourism.php"); 
